...
/* Modified by Anand Balakrishnan, USC, U.S.A for Persephone			  */
...
#ifndef __PERSEPHONE_DISTANCES_H__
#define __PERSEPHONE_DISTANCES_H__
...
double SignedDist2(int *xx, ConvSet *SS, int dim);
...
#endif // __PERSEPHONE_DISTANCES_H__
